...
public class Frequency implements Serializable {
    ...
    public void print() {
    	...
    	for ( Entry<Comparable<?>, Long> entry : this.sortByValue()) {
     ...
     * @return
     */
    public List<Map.Entry<Comparable<?>, Long>> sortByValue() {
        
        List<Map.Entry<Comparable<?>, Long>> sortedEntries = new ArrayList<Map.Entry<Comparable<?>, Long>>();
        sortedEntries.addAll(this.freqTable.entrySet());
        
        Collections.sort(sortedEntries, new Comparator<Map.Entry<Comparable<?>, Long>>() {
                
            public int compare(Map.Entry<Comparable<?>, Long> e1, Map.Entry<Comparable<?>, Long> e2) {
