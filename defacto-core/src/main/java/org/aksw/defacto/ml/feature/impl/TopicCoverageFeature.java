 ...
 */
public class TopicCoverageFeature extends AbstractFeature {
...
//                }
        ...
        evidence.getFeatures().setValue(AbstractFeature.TOPIC_COVERAGE_MAX, maxScore);
        evidence.getFeatures().setValue(AbstractFeature.TOPIC_COVERAGE_SUM, sumScore);
