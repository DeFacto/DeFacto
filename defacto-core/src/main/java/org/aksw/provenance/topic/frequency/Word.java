package org.aksw.provenance.topic.frequency;

/**
 * Created by IntelliJ IDEA. User: Mohamed Morsey Date: 3/9/12 Time: 12:07 PM A
 * Word in a string along with its frequency
 */
