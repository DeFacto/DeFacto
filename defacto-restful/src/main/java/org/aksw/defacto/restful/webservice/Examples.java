...
public class Examples {
  ...
  @RequestMapping(value = "/supportedrelations", headers = "Accept=application/json",
   ...
   * @return json object
   */
  @RequestMapping(value = "/triple", headers = "Accept=application/json",
      produces = "application/json", method = RequestMethod.GET)
  @ResponseBody
  public String exampleinput() {
    final Triple t = DummyData.getDummyTriple();
    return new JSONObject().put("s", t.getSubject().getURI().toString())
        .put("p", t.getPredicate().getURI().toString()).put("o", t.getObject().getURI().toString())
        .put("from", "1910").put("to", "1930").toString();
  }
  ...
  public String exampleinputs() {
    return new JSONArray()
        .put(new JSONObject().put("s", "http://dbpedia.org/resource/Albert_Einstein")
