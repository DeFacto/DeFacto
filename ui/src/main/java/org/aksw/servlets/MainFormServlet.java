...
public class MainFormServlet extends ApplicationServlet {
    ...
    protected void writeAjaxPageHtmlVaadinScripts(Window window,
        ...
        page.write("//<![CDATA[\n");
        page.write("document.write(\"<script language='javascript' src='./jquery/jquery-1.7.2.min.js'><\\/script>\");\n");
