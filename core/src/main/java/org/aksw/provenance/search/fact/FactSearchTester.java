...
import org.aksw.provenance.util.CSVWriter;
import org.aksw.provenance.util.LabeledTriple;
...
//        }
    ...
    public static String checkTriple(String subject, String predicate, String object) throws IOException {
        ...
        // SPARQL is only used to get the labels
        SPARQL sparql = new SPARQL("http://live.dbpedia.org/sparql", "http://dbpedia.org");
