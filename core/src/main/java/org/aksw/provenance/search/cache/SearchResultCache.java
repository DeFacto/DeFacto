 ...
 * 
 */
package org.aksw.provenance.search.cache;
 ...
 *
 */
public class SearchResultCache implements Cache<SearchResult> {

    private Logger logger = Logger.getLogger(SearchResultCache.class);
