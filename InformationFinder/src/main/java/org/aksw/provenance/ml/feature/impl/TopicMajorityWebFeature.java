 ...
 *
 */
public class TopicMajorityWebFeature extends AbstractFeature {
...
//            }
        ...
        evidence.getFeatures().setValue(AbstractFeature.TOPIC_MAJORITY_WEB_SUM, sumScore);
        evidence.getFeatures().setValue(AbstractFeature.TOPIC_MAJORITY_WEB_MAX, maxScore);
