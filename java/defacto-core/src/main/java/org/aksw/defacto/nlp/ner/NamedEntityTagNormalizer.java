...
public class NamedEntityTagNormalizer {
	 ...
	 * 
	 */
    public static final String NAMED_ENTITY_TAG_MONEY = "MONEY";

    public static final String NAMED_ENTITY_TAG_PERCENT = "PERCENT";

    public static final String NAMED_ENTITY_TAG_TIME = "TIME";
	...
	static {
		...
		NAMED_ENTITY_TAG_MAPPINGS.put("PERCENT", 	  NAMED_ENTITY_TAG_PERCENT);
		NAMED_ENTITY_TAG_MAPPINGS.put("TIME", 		  NAMED_ENTITY_TAG_TIME);
		NAMED_ENTITY_TAG_MAPPINGS.put("DATE", 		  NAMED_ENTITY_TAG_DATE);
		NAMED_ENTITY_TAG_MAPPINGS.put("MONEY", 		  NAMED_ENTITY_TAG_MONEY);
	}
}
